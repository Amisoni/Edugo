...
<td width="100px" class="label"><input type="text" name="first_name" placeholder="First Name" style="width:88px; height:18px; font-size:15px" /> Last Name <input type="text" name="last_name" placeholder="Last Name" style="width:88px; height:18px; font-size:15px" />
</td>
</tr>
<tr>
<td width="120px" class="label">School Name:</td>
...
<input name="sex" type="radio" value="Male" checked="checked"/>Male</td>
