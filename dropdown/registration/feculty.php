...
<td width="100px" class="label"><input name="f_name" type="text" placeholder="First Name" style="width:85px; height:18px; font-size:15px"/>
Last Name:<input name="l_name" type="text" placeholder="Last Name" style="width:85px; height:18px; font-size:15px" />
</td>
</tr>
<tr>
...
<td>
<input type="text" name="institute" placeholder="Enter Name Of Institute" class="placeholder"/>
</td></tr>
<tr>
...
<td><input name="sub" type="text" placeholder="Enter Subject Name" class="placeholder"/>
</td>
</tr>
<tr>
...
<td><input type="text" name="number" placeholder="Enter Contact Number" class="placeholder"/>
</td>
</tr>
<tr>
