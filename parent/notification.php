...
$result=mysql_query("SELECT * FROM exam_expert e, result r, sun s, student s1 WHERE s.p_id =".$id." AND r.sid = s.s_id AND e.r_id = r.rid AND s1.id = s.s_id and e.u_type='p'");
echo "<table width='60%'>";
