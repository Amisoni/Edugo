...
function showchap(b)
{
    ...
    document.getElementById("txtchap").innerHTML=xmlhttp.responseText;
	 ...
	 xmlhttp.open("GET","expertpapername.php?cname="+p+"&&sname="+b,true); 
	 xmlhttp.send();
...
xmlhttp.onreadystatechange=function()
 ...
 xmlhttp.open("GET","expertpapername.php?q="+str,true); 
 xmlhttp.send();
...
-->
<table border="0" cellspacing="8px" cellpadding="8px" align="center"  width="50%" style="margin-top:50px; vertical-align:top">
    <tr id="msg">
    ...
    <!--<tr align="left"></tr>
     <tr id="txtchap"><td><th colspan="2" align="justify" style="font-size:15px;"></th></td></tr>
      <td colspan="2"></td><td align="left"></td>
    </tr> -->

</table>
 <!-- <center><a href="https://gpv1r2ryhwb4jljtvt7k2g-on.drv.tw/web/quiz-maker Test-1.html">StartExam</a></center>
  -->
  <center> <button><a href="exam.php">StartExam</a> </button></center>
<!--</form>-->
