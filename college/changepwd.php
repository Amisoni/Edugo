...
<tr>
<td colspan="3">
<h2 style="color:#de6e1d;font-size:18px"><u>Change Password</u></h2>
</td>
</tr>
...
$result=mysql_query("update student set password='".$_GET['npwd']."' where password='".$_GET['opwd']."' and id=".$id."");	
