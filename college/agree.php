...
if(isset($_GET['btndisagree']))
{
	...
	//header('location:../registration/first.php?id='.$id);
	printf("<script>location.href='../registration/first.php'</script>");
	//header('location:../registration/first.php');
}
if(isset($_GET['btnagree']))
{
	printf("<script>location.href='../student/header2.php?id=btnagree'</script>");
	//header('Location:../student/header2.php?id=btnagree');
}
