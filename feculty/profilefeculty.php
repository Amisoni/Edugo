...
var pwd=document.forms["edit"]["npwd"].value;
    ...
    document.getElementById("pmsg").innerHTML=xmlhttp.responseText;
	 ...
	 xmlhttp.open("GET","edit_php.php?old="+old+"&&new="+pwd,true); 
	 xmlhttp.send();
}
</script>
</head>
...
<td id="acc1" width="100px" height="30px;"><label onclick="display('s_add')">Account Details</label></td>
...
<td id="p_del1"><label onclick="display('p_del')">Qulification</label></td>
...
<tr>
	...
	<tr>
        ...
        Permenent Address:</td><td>
            ...
            <tr>   
            <td>Town :</td><td><input type="text" name="town" id="town" size="25px"/></td>
			</tr>
            <tr>
           <td>City :</td><td><select name="city" id="city" style="width:185px">
			...
			<tr>
            <td>
            Zip code :</td><td><input type="text" name="zipcode" id="zipcode" size="25px"/></td>
            </tr>
            <tr>
            <td>  
 	        Neighberhood:</td><td><input type="text" name="neighberhood" id="neighberhood" size="25px"/></td>
            </tr>
            
            
    
<tr>
	<td colspan="3"><input type="button" name="b_address" value="Next" onclick="display('s_det')"/>
...
<table id="p_del" align="center" style="display:none; width:60%; vertical-align:top;" cellpadding="5" cellspacing="5">
	...
	<table id="archi" align="center" style="display:none; width:60%; vertical-align:top;" cellpadding="5" cellspacing="5">
    	...
    	<tr>
        <th><h2><u>School Detail</u></h2></th></tr><tr>
        ...
        <input type="text" name="contactno" id="contactno"/>
         ...
         <tr>
        <td  colspan="3"><input type="submit" value="Save&Exit"/></td>
        </tr>
       <tr>
