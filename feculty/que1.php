...
$result=mysql_query("insert into  expert_paper (u_id,c_id,s_id,u_type) values('".$_SESSION['id']."','".$_POST['cla_id']."','".$_POST['sub_id']."','f')");
